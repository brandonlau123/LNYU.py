...
StarcowURL = "http://www.starcowparis.com/35-all-products"
...
class StarcowSpider(Spider):
    
    name = "StarcowSpider"
    allowded_domains = ["starcowparis.com"]
    start_urls = [StarcowURL]
    
    def __init__(self):
        logging.critical("StarcowSpider STARTED.")
    ...
    def parse(self, response):
        ...
        yield Request(StarcowURL, callback=self.parse, dont_filter=True, priority=102)
